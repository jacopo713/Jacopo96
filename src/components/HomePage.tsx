    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600">
          Scopri la nostra collezione di giochi e test per migliorare le tue
          capacità mentali
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        ...
        >
          ...
          <p className="text-gray-600">
            Metti alla prova il tuo quoziente intellettivo con una serie di
            domande che coprono diverse aree cognitive: logica, spaziale,
            numerica e altro.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-gray-600">
            Affronta il classico puzzle numerico con diversi livelli di
            difficoltà. Migliora la tua logica e capacità di problem solving.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-gray-600">
            Migliora la tua velocità di lettura e la percezione visiva
            periferica. Un esercizio classico per potenziare l'attenzione e la
            concentrazione.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-600">
              Aumenta la tua capacità di concentrazione e la velocità di
              elaborazione visiva.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-600">
              Potenzia le tue capacità logiche e di problem solving attraverso
              sfide stimolanti.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-600">
              Esercita regolarmente le tue funzioni cognitive per mantenerle
